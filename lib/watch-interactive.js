...
const filterHandler = (short, long, prop, { single = false } = {}) => ({
  test: includes(
...
const parseCmdHandler = cmd => {
  ...
  if (arg) {
    return filterHandler(short, long, prop, options)
  }
...
const handlers = [
  ...
  ['--pipe [commands:pipe...]', { single: true }], // TODO should be <commands:pipe...>
